...
export function SocketProvider({ children }) {
    ...
    const [reconnectCount, setReconnectCount] = useState(0); // increments on every successful reconnect
    ...
    useEffect(() => {
        ...
        const initializeSocket = async () => {
            ...
            socket.on('reconnect', (attemptNumber) => {
                ...
                setIsConnected(true);
                setReconnectCount(prev => prev + 1); // signal consumers to re-join rooms
