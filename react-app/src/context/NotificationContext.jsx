...
export function NotificationProvider({ children }) {
    ...
    const addToast = useCallback((notification) => {
        ...
        if (['party_invite', 'friend_request', 'friend_accepted'].includes(notification.type)) {
    ...
    useEffect(() => {
        ...
        // Party invite
        const handlePartyInvite = ({ fromUserId, userData, roomId, movieId, contentType, season, episode, movieTitle, timestamp }) => {
        ...
        // Friend accepted (server emits { userId, userData })
        const handleFriendAccepted = ({ userId, userData }) => {
            console.log('✅ Friend request accepted:', { userId, userData });
